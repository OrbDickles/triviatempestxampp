<?php 
	...
	if (isset($_POST["Number"]) && !empty($_POST["Number"]) &&
		...
		AddTr($_POST["Number"], $_POST["Password"], $_POST["Lname"], $_POST["Fname"], $_POST["Mname"], $_POST["GradeLvl"], $_POST["SchoolID"], $_POST["TeacherID"]);
	}

	function AddTr($Number, $Password, $Lname, $Fname, $Mname, $GradeLvl, $SchoolID, $TrGameID){
		GLOBAL $con;
		$sql = "INSERT INTO student (Number, Password, Lname, Fname, Mname, GradeLvl, SchoolID, TeacherID) 
